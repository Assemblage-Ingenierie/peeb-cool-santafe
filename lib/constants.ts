...
// adouci depuis #d81b7a (trop criard en trait fin sur l'appli). ⚠ Reste PROCHE de
// la TYPOLOGIE Hospitales (#d81b7a) — parenté assumée : rôles distincts (trait fin
// « Medidas » vs badge plein « Tipo »), ils ne se croisent pas.
const MED_SOLAR = "#cf4d89";
...
export const ROADMAP_TAREAS: RoadmapTarea[] = [
  ...
  // Protocolo de Medición y Verificación (M&V) — responsable UG, una tarea por fase.
  { id: "ee-antep-mv", fase: "anteproyecto", componente: "EE", nombre: "Determinar modalidades de protocolo M&V", responsable: "UG", comentario: "Fijar la frontera de medición y la opción IPMVP del edificio; identificar los usos a submedir; inscribir el principio de un plan de medición. Aquí se decide la elección C/D/B, cuando su costo es nulo." },
  { id: "ee-pe-mv", fase: "proyecto_ejecutivo", componente: "EE", nombre: "Asegurar integración de requisitos del protocolo M&V al proyecto ejecutivo", responsable: "UG", comentario: "Especificar físicamente la instrumentación: ubicación y cantidad de medidores (resolver aquí las tres acometidas del Cullen), submedidores por uso, puntos de medición térmica sobre VRF/chiller, medición FV, sensores T°/HR permanentes, y la exigencia de exportación de datos del BMS (paso horario, formato recuperable)." },
  { id: "ee-pliegos-mv", fase: "redaccion_pliegos", componente: "EE", nombre: "Asegurar las especificaciones necesarias al protocolo M&V", responsable: "UG", comentario: "Transcribir las especificaciones en cláusulas oponibles: listas de puntos de medición, clases de precisión, obligación de calibración y certificados, entrega de los datos del período de puesta en marcha, y una cláusula de commissioning que sirva de punto de partida de la línea de base posterior a las obras." },
  { id: "ee-lic-mv", fase: "licitacion", componente: "EE", nombre: "Asegurar cumplimiento de las ofertas con los requisitos del protocolo M&V", responsable: "UG", comentario: "Verificar con una grilla: ¿la oferta cubre todos los puntos de medición? ¿Las precisiones anunciadas son conformes? ¿El oferente aporta un plan de commissioning y de exportación de datos? Una oferta muda sobre estos puntos es no conforme desde la perspectiva del M&V." },
  { id: "ee-obra-mv", fase: "obra", componente: "EE", nombre: "Verificar la correcta instalación de los dispositivos de medición del protocolo M&V", responsable: "UG", comentario: "Verificar en la recepción: medidores instalados y calibrados, datos accesibles, sensores funcionales, y recolección de los datos de commissioning que establecen el estado «después» inicial. Es el cierre previo al traspaso a la UG." },
