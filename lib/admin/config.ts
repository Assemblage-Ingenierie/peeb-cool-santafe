...
export const TABLES: Record<string, TableConfig> = {
  gp: {
    ...
    uidPrefix: "GP-DOC-",
    uidPad: 4,
    textFields: ["nombre_documento", "componente", "url"],
    notNull: ["nombre_documento"],
    dateFields: [],
    flagFields: ["confidencial", "publicar"],
    arrayFields: [],
    select: "uid, nombre_documento, componente, url, confidencial, publicar, orden",
    defaults: { nombre_documento: "", componente: null, url: null, confidencial: false, publicar: false },
    orderBy: [
